...
void ChassisTankDriveCommand::execute()
{
    ...
    chassis.setVelocityTankDrive(
        scale(operatorInterface.getChassisTankLeftInput()),
        scale(operatorInterface.getChassisTankRightInput()));
}

// STEP 3 (Tank Drive): end function
void ChassisTankDriveCommand::end(bool) { chassis.setVelocityTankDrive(0, 0); }
};  // namespace control::chassis
